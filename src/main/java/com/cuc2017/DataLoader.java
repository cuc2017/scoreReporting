...
public class DataLoader implements ApplicationRunner {
  ...
  private void loadAdultDivisions() {
    Division openDivision = new Division("Open", 3, "CUC2018 Open");
    getDivisionRepository().save(openDivision);
    Division womenDivision = new Division("Women", 4, "CUC2018 Women");
    getDivisionRepository().save(womenDivision);
    Division masterOpenDivision = new Division("Masters Open", 1, "CUC2018 MastersOpen");
    getDivisionRepository().save(masterOpenDivision);
    Division masterWomenDivision = new Division("Masters Women", 2, "CUC2018 MastersWomen");
