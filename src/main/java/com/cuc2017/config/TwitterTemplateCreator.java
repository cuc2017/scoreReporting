...
public class TwitterTemplateCreator {
	...
	public Map<String, TwitterTemplate> twitterTemplates() {
		...
		// String field14ConsumerKey = "";
		// String field14ConsumerSecret = "";
		// String field14AccessToken = "";
		// String field14AccessTokenSecret = "";

		// String field15ConsumerKey = "";
		// String field15ConsumerSecret = "";
		// String field15AccessToken = "";
		// String field15AccessTokenSecret = "";

		// String field16ConsumerKey = "";
		// String field16ConsumerSecret = "";
		// String field16AccessToken = "";
		// String field16AccessTokenSecret = "";
